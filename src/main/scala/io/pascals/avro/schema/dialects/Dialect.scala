...
trait Dialect {
  ...
  def mapPrimitiveDataType( primitiveType: PrimitiveTypeMeta ): String = primitiveType match {
  ...
  * */
  ...
  def getSpecificAnnotation( annotationName: String, hasAnnotations: HasAnnotations ): Option[AnnotationMeta]
  ...
  def generateColumnsExpression( classTypeMetaData: ClassTypeMeta, fieldsExpressions: Iterable[String] ): String =
  ...
  def alterDataModel( classTypeMeta: ClassTypeMeta, fieldsExpressions: Iterable[String] ): String

  def generateDataModel( classTypeMeta: ClassTypeMeta, fieldsExpressions: Iterable[String] ): String
